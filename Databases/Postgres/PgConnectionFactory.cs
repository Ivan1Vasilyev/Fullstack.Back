...
namespace Backend.Databases.Postgres
{
    public class PgConnectionFactory : IPgConnectionFactory
    {
        ...
        private static void CreateParameters(NpgsqlCommand comm, params object?[] parameters)
        {
        ...
        public NpgsqlConnection GetPgConnection() => new(_cs);

        public NpgsqlConnection GetPgConnection(string csString) => new(csString);
